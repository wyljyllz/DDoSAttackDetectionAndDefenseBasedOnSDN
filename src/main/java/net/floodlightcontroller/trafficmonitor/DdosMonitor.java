...
public class DdosMonitor implements IOFMessageListener, IFloodlightModule, ITrafficMonitorService {
	
	protected static final Logger logger = LoggerFactory.getLogger(DdosMonitor.class);
	...
	private DdosCollector trafficCollector = new DdosCollector();
	...
	public String getName() {
		...
		return DdosMonitor.class.getSimpleName();
	}
	...
	public HashMap<NodePortTuple, SwitchPortStatistics> getPortStatistics() {
		// TODO Auto-generated method stub
		return DdosCollector.prePortStatsBuffer;
	}	
	
	@Override
	public SwitchPortStatistics getPortStatistics(DatapathId dpid, OFPort port) {
		// TODO Auto-generated method stub
		return DdosCollector.prePortStatsBuffer.get(new NodePortTuple(dpid, port));
	}
